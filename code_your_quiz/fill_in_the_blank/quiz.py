...
def guess_check(word):
    variant = input("What is the value of: ").lower()
    return variant

# prompts the user to enter level typeself.
# according to the answer, return respective data
